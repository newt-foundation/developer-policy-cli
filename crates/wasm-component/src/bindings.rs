...
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.41.0:sunfishcode:hello-wasi-http:target-world:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6525] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xfa1\x01A\x02\x01A\x17\
...
\0\x0aget-stdout\x01\x03\x03\0\x15wasi:cli/stdout@0.2.0\x05\x0f\x04\0(sunfishcod\
e:hello-wasi-http/target-world\x04\0\x0b\x12\x01\0\x0ctarget-world\x03\0\0\0G\x09\
